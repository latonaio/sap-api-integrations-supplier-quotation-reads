...
import (
	...
	sap_api_input_reader "sap-api-integrations-supplier-quotation-reads/SAP_API_Input_Reader"
	"sap-api-integrations-supplier-quotation-reads/config"
...
func main() {
	...
	inputSDC := fr.ReadSDC("./Inputs/SDC_Supplier_Quotation_Header_sample.json")
	...
	caller.AsyncGetSupplierQuotation(
		inputSDC.SupplierQuotation.SupplierQuotation,
		inputSDC.SupplierQuotation.SupplierQuotationItem.SupplierQuotationItem,
		accepter,
	)
}
